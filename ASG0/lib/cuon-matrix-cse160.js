...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        let i = (other2.elements[2]*other1.elements[1]) - (other1.elements[2] * other2.elements[1]);
    ...
    magnitude() {
        ...
        // Don't delete the return statement.
        //magnitude of vector is pretty much just Pythagorean thm
        let inner = this.elements[0] ** 2 + this.elements[1] ** 2 + this.elements[2] ** 2;
        m = Math.sqrt(inner);
        return m;
    };
    ...
    normalize() {
        ...
        //normalize is just dividing it by the magnitude
